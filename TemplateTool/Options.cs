    ...
    public class Options
    {
        ...
        public static void Parse(Options options)
        {
            ...
            switch (options.GenType)
            {
                ...
                case "cpp_tmplmgr":
                    iGenerator = new CPPServerGeneratorWithTmplMgr();
                    OnGenerateCode(options, (int)GeneratorType.CPPServerWithTmplMgr, iGenerator);
                    break;
        ...
        public static void OnGenerateCode(Options options, int genType, IGenerator iGenerator)
        {
            ...
            string tag = "as3";    
            if (genType == (int)GeneratorType.CPPServer 
                || genType == (int)GeneratorType.JsonServer
                || genType == (int)GeneratorType.CPPServerWithTmplMgr)
            {
                tag = "cpp";
            }
