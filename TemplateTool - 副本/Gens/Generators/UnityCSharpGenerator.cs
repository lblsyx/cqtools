...
{
    [Generator((int)GeneratorType.UnityCSharp, "Unity3D代码", true)]
    public class UnityCSharpGenerator : IGenerator
    {
        /// <summary>
        /// {0}：模板类名
        /// {1}：字段代码
        ...
        public void Generate(IList<TableInfo> schemas, string outPath, object others)
        {
