...
namespace UnityLight.Exts
{
    ...
    public class QueueElementFloat<T>
    {
        /// <summary>  
        /// Key值  
        /// </summary>  
        public float KeyValue { get; internal set; }
        /// <summary>  
        /// 实际对象  
        /// </summary>  
        public T Element { get; private set; }
        public QueueElementFloat(T Item, float KeyVal)
        {
            KeyValue = KeyVal;
            Element = Item;
        }
    ...
    public class MinHeapFloat<T>
    {
        /// <summary>  
        /// 队列元素存放，采用List实现.  
        /// </summary>  
        private List<QueueElementFloat<T>> _queueValues = new List<QueueElementFloat<T>>();
        /// <summary>  
        /// 队列元素数目  
        /// </summary>  
        ...
        public void ChangeKey(Func<T, bool> SelectFunc, float NewKey)
        {
            int theIndex = -1;
        ...
        /// <param name="i"></param>  
        /// <param name="NewKey"></param>  
        public void ChangeKey(int i, float NewKey)
        {
            int theIndex = i;
            if (_queueValues[theIndex].KeyValue > NewKey)
            {
        ...
        {
            QueueElementFloat<T> theTmp = _queueValues[i];
        ...
        public void HeapInsert(T Element, float Key)
        {
            _queueValues.Add(new QueueElementFloat<T>(Element, int.MinValue));
